...
| **Simple family** — near-identical, no sidebar         | [game-formats/[slug]/](../frontend/src/routes/game-formats/%5Bslug%5D/) wrapping [SimpleTaxonomyDetailLayout.svelte](../frontend/src/lib/components/SimpleTaxonomyDetailLayout.svelte)    | Thin per-entity wrapper around the shared layout.                                                                                                     |
