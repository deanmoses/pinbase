  ...
  overrides: [
    ...
    // each file is cleaned up.
    {
      files: [
        ...
        'src/lib/components/DeletePage.svelte',
        'src/lib/components/CreatePage.svelte',
        'src/lib/components/ChipGroup.svelte',
        'src/lib/components/SectionEditorForm.svelte',
        ...
        'src/lib/components/form/citation/CitationIdentifyBySearchStage.svelte',
        'src/lib/components/form/citation/CitationCreateStage.svelte',
        'src/lib/components/form/citation/CitationSearchStage.svelte',
        'src/lib/components/form/citation/CitationAutocomplete.svelte',
